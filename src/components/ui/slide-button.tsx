...
interface SlideButtonProps extends Omit<ButtonProps, "onComplete"> {
  onComplete?: () => void;
}
  ...
  ({ className, onComplete, ...props }, ref) => {
    ...
    return (
      ...
      >
          ...
          {!completed && (
            ...
            >
              <Button
                ...
                size="icon"
                className={cn(
                  "shadow-lg rounded-full h-10 w-10 bg-white text-black hover:bg-white/90 drop-shadow-xl",
        ...
        <AnimatePresence key="completion-state">
          {completed && (
            <motion.div
            ...
            >
              <Button
                ...
                {...props}
                className={cn(
                  "size-full rounded-full transition-all duration-300 bg-primary text-white hover:bg-primary/90",
                  className
                )}
              >
